...
class Backup final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::spanner::admin::database::v1::EncryptionInfo* release_encryption_info();
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Timestamp* release_version_time();
...
class CreateBackupRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::spanner::admin::database::v1::Backup* release_backup();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::spanner::admin::database::v1::CreateBackupEncryptionConfig* release_encryption_config();
...
class BackupInfo final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_source_database();
