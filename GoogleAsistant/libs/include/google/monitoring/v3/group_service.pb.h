...
class ListGroupsRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_children_of_group();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_ancestors_of_group();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_descendants_of_group();
...
class CreateGroupRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::monitoring::v3::Group* release_group();
