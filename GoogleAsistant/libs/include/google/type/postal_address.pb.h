...
class PostalAddress final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_region_code();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_sorting_code();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_administrative_area();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_locality();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_sublocality();
