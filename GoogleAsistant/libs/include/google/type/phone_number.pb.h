...
class PhoneNumber_ShortCode final :
 ...
 public:
  ...
  inline PhoneNumber_ShortCode* New() const final {
    return new PhoneNumber_ShortCode();
  }
...
class PhoneNumber final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_e164_number();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::type::PhoneNumber_ShortCode* release_short_code();
