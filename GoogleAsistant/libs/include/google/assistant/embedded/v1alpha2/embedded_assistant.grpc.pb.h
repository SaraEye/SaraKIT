...
class EmbeddedAssistant final {
 public:
   ...
   public:
    ...
    class async_interface {
     public:
      ...
      // `AssistResponse.audio_out` messages will always contain sequential portions
      // of audio.
      virtual void Assist(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::google::assistant::embedded::v1alpha2::AssistRequest,::google::assistant::embedded::v1alpha2::AssistResponse>* reactor) = 0;
    };
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class async final :
     ...
     public:
      void Assist(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::google::assistant::embedded::v1alpha2::AssistRequest,::google::assistant::embedded::v1alpha2::AssistResponse>* reactor) override;
     private:
      friend class Stub;
  ...
  template <class BaseClass>
  class WithCallbackMethod_Assist : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_Assist() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackBidiHandler< ::google::assistant::embedded::v1alpha2::AssistRequest, ::google::assistant::embedded::v1alpha2::AssistResponse>(
            [this](
                   ::grpc::CallbackServerContext* context) { return this->Assist(context); }));
    }
    ~WithCallbackMethod_Assist() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Assist(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::google::assistant::embedded::v1alpha2::AssistResponse, ::google::assistant::embedded::v1alpha2::AssistRequest>* /*stream*/)  override {
    ...
    virtual ::grpc::ServerBidiReactor< ::google::assistant::embedded::v1alpha2::AssistRequest, ::google::assistant::embedded::v1alpha2::AssistResponse>* Assist(
      ::grpc::CallbackServerContext* /*context*/)
      { return nullptr; }
  };
  typedef WithCallbackMethod_Assist<Service > CallbackService;
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_Assist : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_Assist() {
      ::grpc::Service::MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackBidiHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context) { return this->Assist(context); }));
    }
    ~WithRawCallbackMethod_Assist() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Assist(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::google::assistant::embedded::v1alpha2::AssistResponse, ::google::assistant::embedded::v1alpha2::AssistRequest>* /*stream*/)  override {
    ...
    virtual ::grpc::ServerBidiReactor< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* Assist(
      ::grpc::CallbackServerContext* /*context*/)
      { return nullptr; }
  };
