...
class TypedValue final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Distribution* release_distribution_value();
...
class Aggregation final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Duration* release_alignment_period();
