...
class Schema final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_definition();
...
class CreateSchemaRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_schema_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::pubsub::v1::Schema* release_schema();
