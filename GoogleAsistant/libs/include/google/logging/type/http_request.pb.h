...
class HttpRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_request_method();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_request_url();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_referer();
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Duration* release_latency();
