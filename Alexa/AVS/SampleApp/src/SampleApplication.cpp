...
void SampleApplication::pushExternalTap(){
    m_interactionManager->tap();
}

UIManager::States SampleApplication::getStatus(){
    return m_userInterfaceManager->getStatus();
}
...
bool SampleApplication::initialize(
     ...
     */
    m_userInterfaceManager = manufactory->get<std::shared_ptr<alexaClientSDK::sampleApp::UIManager>>();
    if (!m_userInterfaceManager) {
    ...
    authDelegate->addAuthObserver(m_userInterfaceManager);
    m_capabilitiesDelegate->addCapabilitiesObserver(m_userInterfaceManager);
    ...
    client->addBluetoothDeviceObserver(m_userInterfaceManager);
    ...
    m_userInterfaceManager->configureSettingsNotifications(client->getSettingsManager());
