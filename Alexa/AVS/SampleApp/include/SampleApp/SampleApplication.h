...
public:
    ...
    /**
     * Rises tap event from external source.
     *
     * @return Returns a @c SampleAppReturnCode.
     */

    void pushExternalTap();
    /**
     * Rises tap event from external source.
     *
     * @return Returns current alxa state
     */
    UIManager::States getStatus();
...
private:
    ...
    std::shared_ptr<UIManager> m_userInterfaceManager;
