...
class BindingDelta final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_member();
...
class AuditConfigDelta final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_exempted_member();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_log_type();
