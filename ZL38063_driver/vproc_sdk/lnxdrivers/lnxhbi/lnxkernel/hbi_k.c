...
{
    {
        ...
        .ops = {
            //.owner = THIS_MODULE,
            .proc_write = hbi_proc_reg_rd,
            .proc_read = hbi_proc_reg_rd_dump
        }
    },
    {
        .name = "write_reg",
    ...
    },
    {
        ...
        .ops = {
            //.owner = THIS_MODULE,
            .proc_write = hbi_proc_wr_cfgrec,
            .proc_read = hbi_proc_rd_cfgrec
        }
    },
    {
        .name = "load_fw",
    ...
    #ifdef FLASH_PRESENT
    {
        ...
        .ops = {
        //.owner = THIS_MODULE,
        .proc_read = hbi_proc_save_fwrcfgrec_to_flash,
        }
    },
    {
        ...
        .ops = {
        //.owner = THIS_MODULE,
        .proc_write = hbi_proc_load_fwrcfgrec_from_flash,
        }
    },
    {
        .name = "flash_erase",
        ...
        .ops = {
        //.owner = THIS_MODULE,
        .proc_write = hbi_proc_erase_img_from_flash,
        .proc_read = hbi_proc_erase_flash,
        }
    },
    #endif
};
...
struct hbi_lnx_drv_proc_entries drv_proc_entry[] = {
    {
        ...
        .ops = {
            //.owner = THIS_MODULE,
            .proc_write = hbi_proc_open_dev_wr,
            .proc_read = hbi_proc_open_dev_rd
        }
    },
    {
        .name = "close_device",
        ...
        .ops = {
            //.owner = THIS_MODULE,
            .proc_write = hbi_proc_close_dev_wr,
        }
    }
};
