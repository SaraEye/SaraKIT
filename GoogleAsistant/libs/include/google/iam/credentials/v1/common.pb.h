...
class GenerateAccessTokenRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Duration* release_lifetime();
...
class SignBlobResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_signed_blob();
...
class SignJwtResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_signed_jwt();
