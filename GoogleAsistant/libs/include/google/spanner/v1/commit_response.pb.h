...
class CommitResponse_CommitStats final :
 ...
 public:
  ...
  inline CommitResponse_CommitStats* New() const final {
    return new CommitResponse_CommitStats();
  }
...
class CommitResponse final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Timestamp* release_commit_timestamp();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::spanner::v1::CommitResponse_CommitStats* release_commit_stats();
