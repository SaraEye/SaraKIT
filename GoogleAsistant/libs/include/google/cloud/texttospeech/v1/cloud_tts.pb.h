...
class SynthesizeSpeechRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::cloud::texttospeech::v1::SynthesisInput* release_input();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::cloud::texttospeech::v1::VoiceSelectionParams* release_voice();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::cloud::texttospeech::v1::AudioConfig* release_audio_config();
