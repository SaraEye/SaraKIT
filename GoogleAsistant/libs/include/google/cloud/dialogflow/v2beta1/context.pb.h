...
class CreateContextRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::cloud::dialogflow::v2beta1::Context* release_context();
...
inline ::google::cloud::dialogflow::v2beta1::Context* CreateContextRequest::_internal_mutable_context() {
  ...
  if (context_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::Context>(GetArenaForAllocation());
    context_ = p;
  }
  return context_;
}
inline ::google::cloud::dialogflow::v2beta1::Context* CreateContextRequest::mutable_context() {
  ::google::cloud::dialogflow::v2beta1::Context* _msg = _internal_mutable_context();
...
inline void CreateContextRequest::set_allocated_context(::google::cloud::dialogflow::v2beta1::Context* context) {
  ...
  if (context) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::dialogflow::v2beta1::Context>::GetOwningArena(context);
    if (message_arena != submessage_arena) {
