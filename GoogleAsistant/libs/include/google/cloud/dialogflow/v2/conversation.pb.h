...
class Conversation final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_conversation_profile();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::cloud::dialogflow::v2::ConversationPhoneNumber* release_phone_number();
...
class CreateConversationRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_conversation_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::cloud::dialogflow::v2::Conversation* release_conversation();
