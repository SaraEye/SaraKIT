...
class PlanNode_ShortRepresentation final :
 ...
 public:
  ...
  inline PlanNode_ShortRepresentation* New() const final {
    return new PlanNode_ShortRepresentation();
  }
...
class PlanNode final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::spanner::v1::PlanNode_ShortRepresentation* release_short_representation();
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Struct* release_metadata();
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Struct* release_execution_stats();
